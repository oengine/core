 ...
 * @method static \Illuminate\Support\Collection<string, \OEngine\Core\Support\Core\DataInfo> getData()
 * @method static \OEngine\Core\Support\Core\DataInfo find(string $name)
 ...
 *
 * @see \OEngine\Core\Facades\Plugin
 */
class Plugin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \OEngine\Core\Support\Plugin\PluginManager::class;
    }
}
